...
contract SupplyChain {
    ...
    */
    ...
    modifier forSale(uint sku) {
        require(items[sku].state == State.ForSale, "This item is not ForSale.");
        _;
    }
    ...
    modifier shipped(uint sku) {
        require(items[sku].state == State.Shipped, "This item is not shipped.");
        _;
    }
    ...
    function buyItem(uint sku) public payable forSale(sku) checkValue(sku) paidEnough(msg.value) {
